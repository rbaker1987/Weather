  ...
  function p(e) {
    ...
    if (!/no(-?)highlight|plain|text/.test(n)) {
      ...
      (i.value = f(i.value)),
        ...
        i.second_best &&
          (e.second_best = { language: i.second_best.language, re: i.second_best.r });
    }
  }
  function d(e) {
    x = i(x, e);
...
hljs.registerLanguage('scss', function (e) {
  {
    ...
    ({
      ...
      starts: {
        ...
        eW: !0,
        eE: !0,
        c: [r, o, e.CSSNM, e.QSM, e.ASM, e.CBCM, { cN: 'important', b: '!important' }],
      },
    });
  }
  return {
...
hljs.registerLanguage('d', function (e) {
  var r = {
    ...
    v = e.C('\\/\\+', '\\+\\/', { c: ['self'], r: 10 });
  return { l: e.UIR, k: r, c: [e.CLCM, e.CBCM, v, A, p, w, N, F, f, b, g, m, y, L] };
});
  ...
  return {
    ...
    c: [
      ...
      { cN: 'preprocessor', bK: 'import include', e: ';' },
      {
        ...
        c: [
          e.TM,
          { cN: 'params', b: '\\(', e: '\\)', c: [e.ASM, e.QSM, e.CLCM, e.CBCM, t] },
          { cN: 'type', b: ':', e: c, r: 10 },
        ],
      },
    ],
...
hljs.registerLanguage('profile', function (e) {
  return {
    c: [
      e.CNM,
      { cN: 'built_in', b: '{', e: '}$', eB: !0, eE: !0, c: [e.ASM, e.QSM], r: 0 },
      {
        cN: 'filename',
...
hljs.registerLanguage('scheme', function (e) {
  ...
  return (
    (d.c = [c, l, s, u, p, g].concat(o)), { i: /\S/, c: [n, l, s, p, g].concat(o) }
  );
});
hljs.registerLanguage('stata', function (e) {
  return {
    ...
    c: [
      { cN: 'label', v: [{ b: '\\$\\{?[a-zA-Z0-9_]+\\}?' }, { b: "`[a-zA-Z0-9_]+'" }] },
      { cN: 'string', v: [{ b: '`"[^\r\n]*?"\'' }, { b: '"[^\r\n"]*"' }] },
      {
        cN: 'literal',
        v: [
...
hljs.registerLanguage('monkey', function (e) {
  ...
  return {
    ...
    c: [
      ...
      { cN: 'preprocessor', b: '\\s*#', e: '$', k: 'if else elseif endif end then' },
      { cN: 'pi', b: '^\\s*strict\\b' },
      { bK: 'alias', e: '=', c: [e.UTM] },
      e.QSM,
      n,
      ...
      { cN: 'type', b: /</, e: />/, rB: !0, eE: !1, r: 0 },
      {
        ...
        c: [
          ...
          { cN: 'type', b: /</, e: />/, k: 'reified', r: 0 },
          {
            ...
            r: 0,
            i: /\([^\(,\s:]+,/,
            c: [{ cN: 'typename', b: /:\s*/, e: /\s*[=\)]/, eB: !0, rE: !0, r: 0 }],
          },
          e.CLCM,
          e.CBCM,
        ],
    ...
    c: [
      ...
      t.NM,
      {
        ...
        c: [
          ...
          { cN: 'params', b: /\(/, e: /\)/, c: [o, e, t.ASM, t.CSSNM, t.NM, t.QSM] },
        ],
      },
...
hljs.registerLanguage('mercury', function (e) {
  ...
  return { aliases: ['m', 'moo'], k: i, c: [s, c, t, _, n, e.NM, a, o, { b: /:-/ }] };
});
...
hljs.registerLanguage('livecodeserver', function (e) {
  var r = { cN: 'variable', b: '\\b[gtps][A-Z]+[A-Za-z0-9_\\-]*\\b|\\$_[A-Z]+', r: 0 },
        ...
        c: [
          c.inherit(c.TM, { b: e }),
          {
            ...
            c: [
              ...
              { cN: 'export', b: 'экспорт', eW: !0, l: e, k: 'экспорт', c: [c.CLCM] },
            ],
          },
          c.CLCM,
        ],
...
hljs.registerLanguage('verilog', function (e) {
  return {
    ...
    c: [
      ...
      e.CLCM,
      e.QSM,
      { cN: 'number', b: "\\b(\\d+'(b|h|o|d|B|H|O|D))?[0-9xzXZ]+", c: [e.BE], r: 0 },
      { cN: 'typename', b: '\\.\\w+', r: 0 },
...
hljs.registerLanguage('dos', function (e) {
  var r = e.C(/@?rem\b/, /$/, { r: 10 }),
    t = { cN: 'label', b: '^\\s*[A-Za-z._?][A-Za-z0-9_$#@~.?]*(:|\\s+label)', r: 0 };
  return {
    aliases: ['bat', 'cmd'],
    cI: !0,
    k: {
...
hljs.registerLanguage('xml', function (t) {
  var e = '[A-Za-z0-9\\._:-]+',
    s = { b: /<\?(php)?(?!\w)/, e: /\?>/, sL: 'php', subLanguageMode: 'continuous' },
    c = {
      eW: !0,
      i: /</,
      r: 0,
...
hljs.registerLanguage('nsis', function (e) {
  ...
  return {
    ...
    c: [
      ...
      e.C(';', '$', { r: 0 }),
      { cN: 'function', bK: 'Function PageEx Section SectionGroup SubSection', e: '$' },
      l,
      n,
      i,
      r,
...
hljs.registerLanguage('prolog', function (c) {
  var r = { cN: 'atom', b: /[a-z][A-Za-z0-9_]*/, r: 0 },
    b = { cN: 'name', v: [{ b: /[A-Z][a-zA-Z0-9_]*/ }, { b: /_[A-Za-z0-9_]*/ }], r: 0 },
    a = { b: /\(/, e: /\)/, r: 0 },
    e = { b: /\[/, e: /\]/ },
...
hljs.registerLanguage('oxygene', function (e) {
  ...
  return {
    ...
    c: [
      ...
      e.NM,
      i,
      { cN: 'class', b: '=\\bclass\\b', e: 'end;', k: r, c: [n, o, t, a, e.CLCM, i] },
    ],
  };
});
