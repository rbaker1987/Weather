  ...
  return (function () {
  ...
  })()(
    {
                ...
                if (item.inverseOf) {
                  ...
                  if (!unicode.hasOwnProperty(slug)) {
                    ...
                    throw new ReferenceError(
                      (0, _concat['default'])(
                        (_context3 = ''.concat(ERR_UNKNOWN_REF + fullToken, ' -> '))
      ...
      4: [
        function (require, module, exports) {
          ...
          function isType(value, type) {
            return (
              Object.prototype.toString.call(value) === '[object '.concat(type, ']')
            );
          }
          /**
          ...
          XRegExp.matchChain = function (str, chain) {
            return (function recurseChain(values, level) {
              ...
              function addMatch(match) {
                if (item.backref) {
                  var ERR_UNDEFINED_GROUP = 'Backreference to undefined group: '.concat(
                    item.backref
                  );
            ...
            (0, _forEach['default'])(XRegExp).call(
              ...
              function (match) {
                ...
                if (match.index + match[0].length > lastLastIndex) {
                  output.push(
                    (0, _slice['default'])(str).call(str, lastLastIndex, match.index)
                  );
          ...
          XRegExp.addToken(
            ...
            function (match) {
              ...
              return (0, _concat['default'])((_context7 = '\\'.concat(index))).call(
                _context7,
      ...
      44: [
        function (require, module, exports) {
          ...
          module.exports = function (it) {
            var own = it.indexOf;
            return it === ArrayPrototype ||
              (isPrototypeOf(ArrayPrototype, it) && own === ArrayPrototype.indexOf)
              ? method
              : own;
          };
        },
      ...
      45: [
        ...
        { '../../internals/object-is-prototype-of': 135, '../array/virtual/slice': 39 },
      ],
      46: [
        function (require, module, exports) {
          var isPrototypeOf = require('../../internals/object-is-prototype-of');
        ...
        { '../../internals/object-is-prototype-of': 135, '../array/virtual/sort': 40 },
      ],
      47: [
        function (require, module, exports) {
      ...
      48: [
        ...
        { '../../internals/path': 142, '../../modules/es.object.define-property': 179 },
      ],
      49: [
        function (require, module, exports) {
...
*/
      ...
      96: [
        ...
        { '../internals/a-callable': 57, '../internals/function-uncurry-this': 99 },
      ],
      97: [
        function (require, module, exports) {
      ...
      105: [
        ...
        { '../internals/function-uncurry-this': 99, '../internals/to-object': 157 },
      ],
      106: [
        function (require, module, exports) {
          module.exports = {};
      ...
      132: [
        ...
        { '../internals/enum-bug-keys': 92, '../internals/object-keys-internal': 136 },
      ],
      133: [
        function (require, module, exports) {
      ...
      157: [
        ...
        { '../internals/global': 104, '../internals/require-object-coercible': 145 },
      ],
      158: [
        function (require, module, exports) {
          var global = require('../internals/global');
      ...
      221: [
        ...
        { '../../es/symbol': 51, '../../modules/web.dom-collections.iterator': 207 },
      ],
      222: [
        function (require, module, exports) {
          module.exports = [
