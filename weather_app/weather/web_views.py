...
class DashboardView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["recent_forecasts"] = DailyForecast.objects.select_related(
            "location"
            ...
            if location.latitude and location.longitude:
                try:
                    ...
                    if (
                        ...
                        or (
                            timezone.now() - location.last_observation_time
                        ).total_seconds()
                        > 1800
                    ):
                    ...
                    logger.warning(
                        f"Failed to fetch conditions for {location.name}: {str(e)}"
                    )
